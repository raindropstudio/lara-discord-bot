...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addIntegerOption((option) => option.setName("현재레벨").setDescription("현재 레벨을 입력하세요.").setRequired(true))
    .addNumberOption((option) => option.setName("현재경험치퍼센트").setDescription("현재 경험치 퍼센트를 입력하세요.").setRequired(true))
    .addIntegerOption((option) =>
      option.setName("익스트림성장의비약").setDescription("사용할 익스트림 성장의 비약의 갯수를 입력하세요.").setRequired(false)
    )
    .addIntegerOption((option) => option.setName("성장의비약1").setDescription("사용할 성장의 비약 1의 갯수를 입력하세요.").setRequired(false))
    .addIntegerOption((option) => option.setName("성장의비약2").setDescription("사용할 성장의 비약 2의 갯수를 입력하세요.").setRequired(false))
    .addIntegerOption((option) => option.setName("성장의비약3").setDescription("사용할 성장의 비약 3의 갯수를 입력하세요.").setRequired(false))
    .addIntegerOption((option) => option.setName("태풍성장의비약").setDescription("사용할 태풍 성장의 비약의 갯수를 입력하세요.").setRequired(false))
    .addIntegerOption((option) => option.setName("극한성장의비약").setDescription("사용할 극한 성장의 비약의 갯수를 입력하세요.").setRequired(false)),
