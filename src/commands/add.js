...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addNumberOption((option) => option.setName("처음").setDescription("첫번째 숫자를 입력하세요.").setRequired(true))
    .addNumberOption((option) => option.setName("둘").setDescription("두번째 숫자를 입력하세요.").setRequired(true)),
